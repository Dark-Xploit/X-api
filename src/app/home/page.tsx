...
function Home() {
  ...
  const handleShowMenu = () => {
    document.getElementById("menu")?.classList.toggle("slideoutlr");
      ...
      {isLogin ? (
        <div className="flex flex-col relative items-center fadeIn h-screen balsa overflow-hidden w-screen">
          ...
          <div
            ...
            className="flex w-full top-0 text-xl gap justify-between h-max shadow-lg rounded-b-lg shadow-neutral-800 items-center p-3 backdrop-blur-sm"
          >
            <div>
          ...
          {screenWidth > 1024 ? (
            ...
            showmenu && (
              <div className="flex slideinlr flex-col w-full  h-full">
                <div
                  id="menu"
                  className="backdrop-blur-sm  w-2/5 h-full mt-2 rounded"
                >
